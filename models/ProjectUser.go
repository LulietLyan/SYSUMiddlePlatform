...
type ProjectUser struct {
	...
	PU_password    string     `gorm:"column:PU_password;type:VARCHAR(64)" json:"PU_password"`
	PU_username    string     `gorm:"column:PU_username;type:VARCHAR(256)" json:"PU_username"`
